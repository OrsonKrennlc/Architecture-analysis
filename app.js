...
const S3 = (function () {
  ...
  function ensureMap() {
    ...
    map3.on('load', () => {
      ...
      try {
        map3.addLayer({
          id: BL, type: 'fill-extrusion', source: BSRC, 'source-layer': BSL, minzoom: 12,
          paint: {
            'fill-extrusion-color': '#e8e2d4',
  ...
  return {
    ensureMap, flyTo, SM, setShape, generateSet, exportPoster, exportReportPDF, updateSolar,
    getCurMode: () => curMode,
